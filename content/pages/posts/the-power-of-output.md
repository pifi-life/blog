...
* **學習的目的是改變大腦，不用改變當下的生活處境。**我們往往沒有把學習到的知識應用到真實的生活當中。
* **學習就是一直讀書或是練習，自然會進步。**我們往往容易一昧地學習，卻沒有試著在學習的過程中獲得反饋，去改善學習的方法或加強不足的部分。

在閱讀《最高學以致用法》之後，我們會發現學習最重要的部分在於**「輸出」**，有了新的觀念看待學習─

* **成長曲線取決於輸出量的多寡。**輸出的越多，真正學習到的知識越多，也就成長的越多。
